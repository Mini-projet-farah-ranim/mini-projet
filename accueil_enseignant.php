...
<body translate="no">
  <form id="login-form" action="motdepasse_ens.php?cin=<?php echo $_GET['cin'] ?>" method="post">
...
<script>
  ...
  mdpInput.addEventListener('keyup', () => {
    submitButton.disabled = mdpInput.value.trim() === '';
  });
</script>
</body>

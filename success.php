...
<html
  ...
  <body>
    ...
    <div class="layout-wrapper layout-content-navbar">
      ...
      <div class="misc-wrapper" style="margin-left:20%;">
        <h2 class="mb-4 mx-2">Réclamation envoyée avec succée!</h2>
        <a href="etudiant.php?cin=<?php echo $_GET['cin']; ?>&nom=<?php echo $user['nom']; ?>" class="btn btn-primary" style="margin-left:23%;">Back to home</a>
        <div class="mt-4">
          <img

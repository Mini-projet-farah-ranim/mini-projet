              ...
              <div class="row">
                <div class="col-md-12">
                  <ul class="nav nav-pills flex-column flex-md-row mb-3">
                    <li class="nav-item">
                      <a class="nav-link " href="profil.php?cin=<?php echo $_GET['cin']; ?>"><i class="bx bx-user me-1"></i>Profil</a>
                    </li>
                    <li class="nav-item">
                      <a class="nav-link active" href="profilset.php"
                  ...
                  <div class="card mb-4">
                    ...
                    <hr class="my-0" />
                    <div class="card-body">
                      <form id="formAccountSettings" action="profilsetting.php" method="post" enctype="multipart/form-data">
                        <div class="row">
                       

                          <div class="mb-3 col-md-6">
                            <label for="firstName" class="form-label">Nom</label>
                            <input class="form-control" type="text" name="nom" id="lastName" value="<?php echo $user['nom'] ?>" />
                          </div>
                          <div class="mb-3 col-md-6">
                            <label for="lastName" class="form-label">Prénom</label>
                            <input class="form-control" type="text" name="prenom" id="lastName" value="<?php echo $user['prenom'] ?>" />
                          </div>
                          <div class="mb-3 col-md-6">
                            <label for="email" class="form-label">E-mail</label>
                            <input class="form-control" type="text" name="email" id="lastName" value="<?php echo $user['email'] ?>" />
                          </div>
                          ...
                          <div class="mb-3 col-md-6">
                            ...
                            <div class="input-group input-group-merge">
                              ...
                              <input class="form-control" type="text" name="telephone" id="lastName" value="<?php echo $user['telephone'] ?>" />
                            </div>
                          </div>
                          <div class="mb-3 col-md-6">
                            <label for="address" class="form-label">Groupe</label>
                            <input class="form-control" type="text" name="groupe" id="lastName" value="<?php echo $user['groupe'] ?>" />
                          </div>
                          <div class="mb-3 col-md-6">
                            <label for="state" class="form-label">Filière</label>
                            <input class="form-control" type="text" name="filiere" id="lastName" value="<?php echo $user['filiere'] ?>" />
                          </div>
                          <div class="mb-3 col-md-6">
                          ...
                          <label for="state" class="form-label">Photo de profil</label> <br>
                              <input type="file" id="photo" class="btn btn-outline-secondary account-image-reset mb-4" name="photo" accept="image/jpeg,image/png,image/gif">
                              <small class="form-text text-muted">Formats acceptés : JPEG, PNG, GIF (max 2 Mo)</small>
                            </div>
                        </div>
                        <div class="mt-2">
